...
const _routes = [
  {
    ...
    path: "/admin",
    component: () => import('./admin-f2cJP4eh.mjs'),
    children: [
      {
        name: "admin",
        path: "",
        component: () => import('./index-CGluDR5J.mjs')
      },
      {
        name: "admin-login",
        path: "login",
        component: () => import('./login-BkwEd57X.mjs')
      },
      {
        name: "admin-offres",
        path: "offres",
        component: () => import('./offres-DnSLW6VL.mjs')
      },
      {
        name: "admin-clients",
        path: "clients",
        component: () => import('./clients-CmyAJQTe.mjs')
      },
      {
        name: "admin-services",
        path: "services",
        component: () => import('./services-lXhmqCHA.mjs')
      },
      {
        name: "admin-wallet",
        path: "wallet",
        component: () => import('./index-B2MvJfcb.mjs')
      },
      {
        name: "admin-wallet-demandes",
        path: "wallet/demandes",
        component: () => import('./demandes-CFTLup2E.mjs')
      },
      {
        name: "admin-prestataires-id",
        path: "prestataires/:id()",
        component: () => import('./_id_-B-t7bpBS.mjs')
      },
      {
        name: "admin-prestataires",
        path: "prestataires",
        component: () => import('./index-D-SxU1Mg.mjs')
      },
      {
        name: "admin-notifications",
        path: "notifications",
        component: () => import('./index-CaQcogMA.mjs')
      },
      {
        name: "admin-demandes-mille-services",
        path: "demandes-mille-services",
        meta: __nuxt_page_meta$1 || {},
        component: () => import('./demandes-mille-services-IsO_qdEf.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-B-osWKsp.mjs')
  }
];
...
const admin_45auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
  if (!to.path.startsWith("/admin")) return;
  const isLoginPage = to.path === "/admin/login";
  const accessToken = useCookie("admin_access_token");
  const adminRole = useCookie("admin_role");
  const isAuthenticated = Boolean(accessToken.value) && adminRole.value === "ADMIN";
